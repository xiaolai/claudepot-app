  ...
  return (
    <html lang="en" className={jetbrainsMono.variable}>
      <body>
         ...
         * after the user taps a link inside the popover. Covers both
         * disclosure variants:
         *   - .proto-toc-details: doc TOC pages, OfficeSidebar,
         *     AccountSidebar (anchor links to sections of this page,
         *     so we close on `a[href^="#"]` only — full navigations
         *     close anyway via the route change).
         *   - .docs-sidebar-disclosure: DocsSidebar (sibling-page
         *     links — close on any `a` tap so the popover doesn't
         *     stay open across navigations during transition).
         * The mobile media query is what makes these a popover, so
         * the handlers are cheap on desktop too — they fire on every
