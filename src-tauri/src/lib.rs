...
pub fn run() {
    ...
    builder
        .invoke_handler(tauri::generate_handler![
            ...
            commands::keys::key_api_update_secret,
            ...
            commands::keys::key_oauth_update_secret,
            ...
            commands::thinking_toggle::thinking_state,
            commands::thinking_toggle::thinking_set,
            commands::fast_mode_toggle::fast_mode_state,
            commands::fast_mode_toggle::fast_mode_set,
            commands::fast_mode_toggle::fast_mode_set_per_session,
            commands::available_models::available_models_state,
            commands::available_models::available_models_set,
            commands::auto_dream::auto_dream_state,
            commands::auto_dream::auto_dream_set,
            commands::cc_env::cc_env_list,
            commands::cc_env::cc_env_set,
            commands::cc_env::cc_env_clear,
            ...
            commands::shared_memory::shared_memory_list_evidence,
            commands::shared_memory::shared_memory_memory_links,
            commands::shared_memory::shared_memory_list_sessions,
            commands::shared_memory::shared_memory_list_projects,
            commands::shared_memory::lesson_list,
            commands::shared_memory::lesson_counts,
            commands::shared_memory::lesson_counts_by_project,
            commands::shared_memory::lesson_accept,
            commands::shared_memory::lesson_reject,
            commands::shared_memory::recurrence_list,
            commands::shared_memory::recurrence_confirm,
            commands::shared_memory::recurrence_dismiss,
            commands::shared_memory::recurrence_counts,
