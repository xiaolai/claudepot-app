...
mod tests {
    ...
    fn test_store() -> (AccountStore, tempfile::TempDir) {
        ...
        for email in ["lixiaolai@gmail.com", "account-b@example.com", "account-a@example.com"] {
    ...
    fn test_resolve_prefix_unique() {
        ...
        assert_eq!(resolve_email(&store, "xiaolaid").unwrap(), "account-b@example.com");
        assert_eq!(resolve_email(&store, "xiaolaia").unwrap(), "account-a@example.com");
    }
